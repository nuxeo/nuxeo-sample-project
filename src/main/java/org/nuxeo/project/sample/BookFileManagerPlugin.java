...
public class BookFileManagerPlugin extends AbstractPlugin {
    ...
    public DocumentModel create(CoreSession documentManager, Blob content,
        ...
        DocumentModel doc = documentManager.createDocumentModel(path, randomName,
                "Book");
        doc.setProperty("dublincore", "title", title);
        doc.setProperty("dublincore", "description", filename);
